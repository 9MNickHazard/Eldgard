...
from mechanics import combat_1v1, roll_1v1_initiative, roll_flee_check, roll_damage_value, monster_turn_1v1, player_turn_1v1, roll_stat, seperator, roll_stat_check_d20, get_modifier_value
...
def first_dungeon_jail(character: Character):
    ...
    while True:
        ...
        if puke_choice == 'y':
            ...
            # time.sleep(2)
            print(f"---This is a Dexterity check. A d20 will be rolled and your Dexterity modifier ({get_modifier_value(character.dexterity)}) will be applied---")
            # time.sleep(2)
            ...
            while True:
                jail_key_pickpocket_check = roll_stat_check_d20(character, 10, 'dexterity', 0)
            ...
            while True:
                jail_key_pickpocket_check = roll_stat_check_d20(character, 10, 'dexterity', -2)
                if jail_key_pickpocket_check == True:
                    break
                else:
                    while True:
    ...
    while True:
        ...
        if starting_dungeon_first_choice == 'right':
            ...
            # time.sleep(2)
            initiative = roll_1v1_initiative(first_dungeon_rat, character)
            # time.sleep(2)
            battle_result = combat_1v1(first_dungeon_rat, character, initiative, True)
            ...
            if battle_result == 'player_win':
                ...
                if loot_roll in range(1, first_dungeon_rat.loot_drops['chance_of_nothing'] + 1):
                    ...
                    character.inventory["gold_coins"] += first_dungeon_rat.loot_drops["gold_coins"]
                    # time.sleep(3)
                    print(f"---Here is your inventory---")
                    print(character.inventory)
                    seperator()
            ...
            # time.sleep(3)
            print(f"Guard 1: Ohhhh you should have seen this crazy {character.role} last night at the White Goose Tavern! They were deep in their cups, prancing on tables and bellowing some bawdy tune as if they were a drunken bard.")
            # time.sleep(4)
            seperator()
            ...
            while True:
                ...
                if choice == '1':
                    ...
                    if puke_choice =='y':
                        cha_check = roll_stat_check_d20(character, 12, 'charisma', 2)
                    elif puke_choice =='n':
                        cha_check = roll_stat_check_d20(character, 12, 'charisma', -2)
                    else:
                        cha_check = roll_stat_check_d20(character, 12, 'charisma', 0)
                    ...
                    if cha_check == True:
                        ...
                        # time.sleep(3)
                        print(f"Guard 1: Ayee, that time already? Gloevar, grab {character.name}'s belongs out the chest behind ye. {character.name}, maybe lay off the meade next time. Trot on now.")
                        # time.sleep(3)
                        ...
                        # time.sleep(2)
                        print(f"As you put your hand on door handle, you hear a yell from near where you came from, 'Oi!! Stop that {character.role}! They stole my keys!!'")
                        # time.sleep(3)
                        ...
                        print("You say with confidence, 'Ahhh my good fellows, Olgur just let me out, I've come to collect my personal belongings and be on my merry way!'")
                        # time.sleep(3)
                        print(f"Guard 1: 'Oi! {character.name}, you shouldn't be out yer cell yet! Get over here...'")
                        break
            ...
            while True:
                continue_choice = input("Are you ready to fight the Guard? Please enter y when ready: ")
            ...
            if choice == '1':
                ...
                # time.sleep(2)
                initiative = roll_1v1_initiative(first_dungeon_enraged_guard, character)
                # time.sleep(2)
                battle_result = combat_1v1(first_dungeon_enraged_guard, character, initiative, False)
                ...
                if battle_result == 'player_win':
                    ...
                    if loot_roll in range(1, first_dungeon_enraged_guard.loot_drops['chance_of_nothing'] + 1):
                        ...
                        character.inventory["gold_coins"] += first_dungeon_enraged_guard.loot_drops["gold_coins"]
                        # time.sleep(3)
                ...
                print("First, initiative will be rolled for both you and your opponent. Your Dexterity modifier is applied to this roll. The one with the highest roll will go first.")
                # time.sleep(2)
                initiative = roll_1v1_initiative(first_dungeon_guard, character)
                # time.sleep(2)
                battle_result = combat_1v1(first_dungeon_guard, character, initiative, False)
                ...
                if battle_result == 'player_win':
                    ...
                    if loot_roll in range(1, first_dungeon_guard.loot_drops['chance_of_nothing'] + 1):
                        ...
                        character.inventory["gold_coins"] += first_dungeon_guard.loot_drops["gold_coins"]
                        # time.sleep(3)
                        print(f"---Here is your inventory---")
                        print(character.inventory)
                        seperator()
